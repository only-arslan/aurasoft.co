...
class The7_Elementor_Simple_Posts_Widget extends The7_Elementor_Widget_Base {
	...
	protected function add_content_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .post-entry-content .post-details i:first-child' => 'margin-right: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .post-entry-content .post-details i:last-child'  => 'margin-left: {{SIZE}}{{UNIT}};',
				],
				'condition'  => [
					'show_read_more_button'      => 'y',
					'show_read_more_button_icon' => 'y',
	...
	protected function get_post_title( $settings, $tag = 'h3' ) {
		...
		$output .= '<a ' . the7_get_html_attributes_string( $title_link ) . '>' . $title . '</a>';
		$output .= '</' . $tag . '>';
	...
	protected function add_image_style_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .post-thumbnail-wrap' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px' ],
				'selectors'  => [
					'{{WRAPPER}} .post-thumbnail-wrap img'       => 'border-radius: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .post-thumbnail-wrap .layzr-bg' => 'border-radius: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function add_button_style_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .post-details.details-type-btn:not(.class-1):not(.class-2)',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .post-details.details-type-btn:not(.class-1):not(.class-2)' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .post-details.details-type-btn:not(.class-1):not(.class-2)' => 'background: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .post-details.details-type-btn:not(.class-1):not(.class-2):hover' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .post-details.details-type-btn:not(.class-1):not(.class-2):hover' => 'background: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .post-details.details-type-btn:not(.class-1):not(.class-2):hover' => 'border-color: {{VALUE}}',
				],
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .post-details.details-type-btn:not(.class-1):not(.class-2)' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .post-details.details-type-btn:not(.class-1):not(.class-2)' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator'  => 'before',
			]
		);
		...
		$this->add_control(
			'gap_above_button',
			[
				'label'      => __( 'Button Top Spacing', 'the7mk2' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
				...
				'selectors'  => [
					'{{WRAPPER}} .post-details.details-type-btn:not(.class-1):not(.class-2)' => 'margin-top: {{SIZE}}{{UNIT}};',
				],
			]
		);
