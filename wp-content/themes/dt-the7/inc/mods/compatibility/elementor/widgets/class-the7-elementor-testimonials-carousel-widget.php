...
class The7_Elementor_Testimonials_Carousel_Widget extends The7_Elementor_Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'
					{{WRAPPER}} .dt-slide-button { transition: color 0.3s ease; }
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'
					{{WRAPPER}} .dt-slide-button { transition: all 0.3s ease; }
	...
	protected function render() {
		...
		foreach ( $settings['list'] as $slide ) {
			...
			if ( $slide['button'] ) {
				echo '<' . $btn_element . ' ' . $btn_attributes . ' ' . $this->get_render_attribute_string( 'button' ) . '>' . wp_kses_post( $slide['button'] ) . '</' . $btn_element . '>';
			}
