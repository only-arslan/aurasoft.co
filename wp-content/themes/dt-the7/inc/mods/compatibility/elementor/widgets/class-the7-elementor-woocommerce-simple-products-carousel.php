...
class The7_Elementor_Woocommerce_Simple_Products_Carousel extends The7_Elementor_Widget_Base {
	...
	protected function add_box_content_style_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} article.post' => 'border-style: solid; border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} article.post' => 'border-radius: {{SIZE}}{{UNIT}}; overflow: hidden;',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} article.post' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} article.post' => 'background-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} article.post' => 'border-color: {{VALUE}}',
				],
			]
		);
	...
	protected function add_image_style_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .the7-simple-product-thumb' => 'width: {{SIZE}}{{UNIT}}; --image-ratio: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .product-content'    => '--content-ratio: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px' ],
				'selectors'  => [
					'{{WRAPPER}} .the7-simple-product-thumb img'       => 'border-radius: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .the7-simple-product-thumb .layzr-bg' => 'border-radius: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			'image_space',
			[
				'label'     => __( 'Image Side Spacing', 'the7mk2' ),
				'type'      => Controls_Manager::SLIDER,
				'default'   => [
					'size' => '',
				],
	...
	protected function add_title_style_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .product-content .product-title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .product-content .product-title:hover' => 'color: {{VALUE}};',
				],
			]
		);
	...
	protected function add_price_style_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .product-content .price *',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .product-content .price > span.woocommerce-Price-amount.amount, {{WRAPPER}} .product-content .price > span.woocommerce-Price-amount span, {{WRAPPER}} .product-content .price, {{WRAPPER}} .product-content .price ins span' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .product-content .price del span',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .product-content .price del span' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .product-content .price del' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .product-content .price ins span',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .product-content .price ins span' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px' ],
				'selectors'  => [
					'{{WRAPPER}} .product-content .price' => 'margin-top: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function add_button_style_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .woo-buttons > a',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .woo-buttons > a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .woo-buttons > a' => 'background: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .woo-buttons > a:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .woo-buttons > a:hover' => 'background: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .woo-buttons > a:hover' => 'border-color: {{VALUE}}',
				],
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .the7-simple-products-carousel .woo-buttons a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .the7-simple-products-carousel .woo-buttons a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator'  => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .the7-simple-products-carousel .woo-buttons' => 'margin-top: {{SIZE}}{{UNIT}};',
				],
			]
		);
			...
			echo '<div ' . $this->get_render_attribute_string( 'inner-wrapper' ) . $this->get_container_data_atts() . '>';
				...
				while ( $query->have_posts() ) {
					...
					if ( $settings['show_product_image'] ) {
						echo '<div class="the7-simple-product-thumb">'. $this->product_image( $product ) .'</div>';
					}

					echo '<div class="product-content">';
					if ( $settings['show_title'] ) {
						echo $this->display_product_title( $product, $settings['product_title_tag'] );
					}
					...
					if ( $settings['show_add_to_cart'] ) {
						echo '<div class="woo-buttons">' . $this->display_add_to_cart( $product ) . '</div>';
					}
					echo '</article>';
				}
	...
	protected function get_elementor_icon_html( $icon, $tag = 'i', $class = '' ) {
	...
	protected function product_image( $product ) {

		if ( $product->get_image_id() ) {
			$thumb_args = [
				'img_id'       => $product->get_image_id(),
				'class'        => implode( ' ', [ 'the7-product-thumb', 'img-ratio-wrapper' ] ),
	...
	protected function display_product_title( $product, $tag = 'h3' ) {
		...
		if ( $settings['excerpt_words_limit'] && $settings['title_width'] === 'normal' ) {
			$product_name = wp_trim_words( $product_name, $settings['excerpt_words_limit'] );
		}

		$output = '<' . $tag . ' class="heading">';
		$output .= '<a href="' . esc_url( $product->get_permalink() ) . '" class="product-title">';
