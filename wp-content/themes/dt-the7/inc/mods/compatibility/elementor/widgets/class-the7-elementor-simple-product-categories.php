...
class The7_Elementor_Simple_Product_Categories extends The7_Elementor_Widget_Base {
	...
	protected function add_content_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'separator'    => 'after',
				'selectors'    => [
					'{{WRAPPER}} .product-entry-content' => 'text-align: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .product-entry-content .product-details i:first-child' => 'margin-right: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .product-entry-content .product-details i:last-child'  => 'margin-left: {{SIZE}}{{UNIT}};',
				],
				'condition'  => [
					'show_read_more_button'      => 'y',
					'show_read_more_button_icon' => 'y',
	...
	protected function add_button_style_controls() {
		...
		$this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .product-details' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .product-details' => 'background: {{VALUE}}',
                ],
            ]
        );
		...
		$this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .product-details:hover' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .product-details:hover' => 'background: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .product-details:hover' => 'border-color: {{VALUE}}',
                ],
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%' ],
                'selectors'  => [
                    '{{WRAPPER}} .product-details' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .product-details' => 'margin-top: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
	...
	protected function render() {
		...
		foreach ( $product_categories->terms as $category ) {
			...
			echo '<article class="' . esc_attr( implode( ' ', $post_class_array ) ) . '">';
			...
			if ( $settings['show_read_more_button'] ) {
				echo $this->get_details_btn( $settings, $category );
			}
			echo '</div>';
	...
	protected function get_category_title( $settings, $tag = 'h3', $category ) {
		$tag        = esc_html( $tag );
		$title_link = [
	...
	protected function get_details_btn( $settings, $category ) {
		$icon = '';
		...
		$atts['rel']        = 'nofollow';
		$atts['target']     = '';
		$atts['aria-label'] = the7_get_read_more_aria_label();
		ob_start();
		?>

		<a <?php echo the7_get_html_attributes_string( $atts ) ?>><?php
			if ( $settings['read_more_button_icon_position'] === 'before' ) {
				echo $icon;
			}

			echo '<span>' . esc_html( $settings['read_more_button_text'] ) . '</span>';

			if ( $settings['read_more_button_icon_position'] === 'after' ) {
				echo $icon;
			}
			?>
		</a>
