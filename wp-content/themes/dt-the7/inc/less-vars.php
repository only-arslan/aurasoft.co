...
function presscore_action_add_less_vars( The7_Less_Vars_Manager_Interface $less_vars ) {
	...
	$less_vars->add_pixel_number( 'dt-btn-s-line-height', (int) $button_typography['font_size'] + 2 );
	$less_vars->add_pixel_number( 'dt-btn-s-icon-size', of_get_option( 'buttons-s-icon-size' ) );
	$less_vars->add_pixel_number( 'dt-btn-s-border-radius', of_get_option( 'buttons-s_border_radius' ) );
	$less_vars->add_pixel_number( 'dt-btn-s-border-width', of_get_option( 'buttons-s_border_width' ) );
